...
<%@page import="Restaurante.Utilidades.MensajeCorreo"%>
...
String nombre2="",correo2="";
    if (session.getAttribute("usuario") != null) {
        ...
        <%
            MensajeCorreo correoEmail=new MensajeCorreo();
            
            if (request.getParameter("boton") != null) {
                if (request.getParameter("boton").equalsIgnoreCase("Enviar")) {
                    String nombre = "", correo = "", asunto = "", mensaje = "", encabezado = "", mensajeTotal = "";
                    nombre = request.getParameter("nombre");
                    correo = request.getParameter("correo");
                    asunto = request.getParameter("asunto");
                    mensaje = request.getParameter("mensaje");
                    encabezado = "RESTAURANTE PACOMERALGO \n Enviado por cliente : " + nombre + "\n" + "Correo electronico: " + correo + ".";
                    mensajeTotal= encabezado + "\n Mensaje: \n" + mensaje;
                    correoEmail.EnviarMensajeCorreo("pacomeralgomedellin@gmail.com", asunto, mensajeTotal);
                    %>
